...
public class FPTemplate {
     ...
     */
    public HSSFWorkbook process(String templateName, Map<String, Object> data) throws FPParseException, FPMergeException,IOException {
     ...
     *             ファイルIOでエラーが発生した際に投げられます。
     */
    public HSSFWorkbook process(InputStream is, Map<String, Object> data) throws FPParseException,FPMergeException,IOException {
